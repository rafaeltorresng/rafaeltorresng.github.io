...
export const contactInfo = {
  email: 'rafaeltorresng@gmail.com',
  phone: '+55 81 98251-2792',
  linkedin: 'https://linkedin.com/in/rafaeltng',
  github: 'https://github.com/rafaeltorresng',
  linkedinDisplay: 'linkedin.com/in/rafaeltng',
  githubDisplay: 'github.com/rafaeltorresng'
}

export const languages = [
  { code: '🇧🇷', name: 'Portuguese', level: 'Native' },
  { code: '🇺🇸', name: 'English', level: 'Fluent' },
  { code: '🇪🇸', name: 'Spanish', level: 'Basic' }
] 